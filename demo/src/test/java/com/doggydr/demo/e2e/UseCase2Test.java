...
public class UseCase2Test {
    ...
    public void testAddNewTreatmentAndVerify() {
        // Paso 1: Inicio de sesión del veterinario
        ...
        driver.findElement(By.xpath("//h3[text()='Administrar Mascotas']")).click();
        wait.until(ExpectedConditions.urlContains("/pet/all"));

        // Paso 2: Buscar la mascota "Perry"
        ...
        // Paso 3: Seleccionar tratamiento en el formulario de actualización
        WebElement treatmentDropdown = driver.findElement(By.id("treatment"));
        treatmentDropdown.click();
        WebElement newTreatmentOption = driver.findElement(By.xpath("//option[contains(text(), 'Nuevo Tratamiento para Perry')]"));
        newTreatmentOption.click();

        WebElement saveBtn = driver.findElement(By.cssSelector(".btn-primary"));
        saveBtn.click();
        
        // Paso 4: Verificar que el tratamiento esté asignado
