...
public class MedicineExcelLoader {
    ...
    public List<Medicine> readMedicinesFromExcel(String filePath) {
        ...
        try (FileInputStream fis = new FileInputStream(filePath);
            ...
            // Iterar sobre cada fila de la hoja, comenzando en la fila 1 para saltar la cabecera
            for (int i = 1; i < sheet.getPhysicalNumberOfRows(); i++) {
                ...
                Medicine medicine = new Medicine(name, unitsAvailable, unitsSold, purchasePrice, salePrice);
