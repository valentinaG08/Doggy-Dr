...
public class DatabaseInit implements ApplicationRunner {
    ...
    public void createPets () {
        ...
        petRepository.save(new Pet("Leo", "Weimaraner", 4, "Consultas y chequeos generales", 29.0, "https://www.hundeo.com/wp-content/uploads/2019/02/Weimaraner-Portra%CC%88t-.jpg", clientRepository.findById(30L).get()));
        petRepository.save(new Pet("Ellie", "Shetland Sheepdog", 5, "Vacunaciones y Desparasitación", 7.5, "\thttps://geniusvets.s3.amazonaws.com/gv-dog-breeds/shetland-sheepdog-3.jpg", clientRepository.findById(31L).get()));
        petRepository.save(new Pet("Riley", "Galgo", 3, "Odontología veterinaria", 25.5, "\thttps://cdn.unotv.com/images/2024/01/caracteristicas-del-galgo-jpg-173130.jpg", clientRepository.findById(32L).get()));
        petRepository.save(new Pet("Lilly", "Basenji", 2, "Laboratorio y diagnóstico por Imágenes", 10.5, "https://www.purina.es/sites/default/files/styles/ttt_image_510/public/2024-02/sitesdefaultfilesstylessquare_medium_440x440public2022-08basenji.jpg?itok=0cbpZJgV", clientRepository.findById(33L).get()));
        ...
        petRepository.save(new Pet("Ginger", "Galgo Italiano", 3, "Vacunaciones y Desparasitación", 6.2, "https://upload.wikimedia.org/wikipedia/commons/thumb/5/5f/Italian_Greyhound_standing_gray.jpg/320px-Italian_Greyhound_standing_gray.jpg", clientRepository.findById(35L).get()));
        ...
        petRepository.save(new Pet("Layla", "Husky", 5, "Laboratorioy diagnóstico por Imágenes", 22.0, "https://www.purina.es/sites/default/files/styles/ttt_image_510/public/2024-02/sitesdefaultfilesstylessquare_medium_440x440public2022-08Siberian20Husky2.jpg?itok=d5njFuxB", clientRepository.findById(37L).get())); 
        petRepository.save(new Pet("Murphy", "Galgo Afgano", 4, "Consultas y chequeos generales", 26.0, "https://i.pinimg.com/736x/46/0a/fb/460afb0cc53180384e1c91cf5dac30c1.jpg", clientRepository.findById(38L).get())); 
        petRepository.save(new Pet("Nina", "Pinscher", 2, "Vacunaciones y Desparasitación", 4.5, "https://upload.wikimedia.org/wikipedia/commons/1/13/Pinscher_Miniatura_l%C3%ADnea_Europea_en_Cuernavaca_M%C3%A9xico.jpg", clientRepository.findById(39L).get())); 
        ...
        petRepository.save(new Pet("Milo", "Galgo Español", 5, "Laboratorio y diagnóstico por Imágenes", 28.0, "https://www.kiwoko.com/blogmundoanimal/wp-content/uploads/2024/03/galgo-espanol-raza.jpg", clientRepository.findById(41L).get())); 
        petRepository.save(new Pet("Sasha", "Collie", 6, "Consultas y chequeos generales", 22.5, "https://www.worldlifeexpectancy.com//images/a/d/d/b/collie_rough/collie_rough_1.webp", clientRepository.findById(42L).get())); 
        petRepository.save(new Pet("Hunter", "Fox Terrier", 4, "Vacunaciones y Desparasitación", 8.0, "https://www.purina.es/sites/default/files/2021-02/BREED%20Hero_0050_fox_terrier_wire.jpg", clientRepository.findById(43L).get())); 
        ...
        petRepository.save(new Pet("Beau", "Setter Irlandés", 5, "Consultas y chequeos generales", 27.0, "https://upload.wikimedia.org/wikipedia/commons/thumb/2/2e/Can_Setter_dog_GFDL.jpg/800px-Can_Setter_dog_GFDL.jpg", clientRepository.findById(46L).get())); 
        petRepository.save(new Pet("Misty", "Shiba Inu", 3, "Vacunaciones y Desparasitación", 10.0, "https://www.lavanguardia.com/files/og_thumbnail/files/fp/uploads/2024/04/08/66141a09dbe9d.r_d.2338-1390-3106.jpeg", clientRepository.findById(47L).get())); 
        ...
        petRepository.save(new Pet("Lola", "Golden Retriever", 6, "Laboratorio y diagnóstico por Imágenes", 30.0, "https://13630656.rocketcdn.me/wp-content/uploads/2020/01/Golden4.jpg", clientRepository.findById(49L).get()));
        petRepository.save(new Pet("Finn", "Border Collie", 2, "Vacunaciones y Desparasitación", 15.0, "https://images.ctfassets.net/550nf1gumh01/6dWe4W0fQAJNbTT2GOVoOv/15f5188d1867ea7bdcf5b610d0a699c7/iStock-1420601907.jpg?q=90&w=1240", clientRepository.findById(1L).get()));
        petRepository.save(new Pet("Maya", "Jack Russell Terrier", 3, "Odontología veterinaria", 7.5, "https://www.purina.es/sites/default/files/styles/ttt_image_510/public/2024-02/sitesdefaultfilesstylessquare_medium_440x440public2022-09Parson20Russell20Terrier.jpg?itok=8gUiayIr", clientRepository.findById(2L).get()));
        petRepository.save(new Pet("Riley", "Husky Siberiano", 4, "Laboratorio y diagnóstico por Imágenes", 20.0, "https://www.purina.es/sites/default/files/styles/ttt_image_510/public/2024-02/sitesdefaultfilesstylessquare_medium_440x440public2022-09Siberian20Husky.jpg?itok=JMtF4wzk", clientRepository.findById(3L).get()));
        ...
        petRepository.save(new Pet("Maggie", "Cavalier King Charles Spaniel", 4, "Consultas y chequeos generales", 8.5, "https://www.purina.es/sites/default/files/2021-02/BREED%20Hero_0032_king_charles_spaniel.jpg", clientRepository.findById(12L).get()));
        ...
        petRepository.save(new Pet("Zara", "Corgi", 4, "Vacunaciones y Desparasitación", 13.5, "https://upload.wikimedia.org/wikipedia/commons/thumb/9/99/Welsh_Pembroke_Corgi.jpg/800px-Welsh_Pembroke_Corgi.jpg", clientRepository.findById(17L).get()));
        petRepository.save(new Pet("Dexter", "Boxer", 3, "Odontología veterinaria", 24.0, "https://www.tiendanimal.es/articulos/wp-content/uploads/2020/07/boxer-cachorro-1200x900.jpg", clientRepository.findById(18L).get()));
        petRepository.save(new Pet("Rex", "Dogo Argentino", 5, "Laboratorio y diagnóstico por Imágenes", 36.0, "https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcQUgYX9zTSdHzFWebeKOMvZUke3-j1BydGJ2Q&s", clientRepository.findById(19L).get()));
        petRepository.save(new Pet("Sadie", "Maltés", 2, "Consultas y chequeos generales", 4.0, "https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcQZaKMJ9l2NXSjN65j5lQo2iGT57kh9JH7xQA&s", clientRepository.findById(20L).get()));
        ...
        petRepository.save(new Pet("Sophie", "Pomerania", 3, "Odontología veterinaria", 5.5, "https://cloudfront-us-east-1.images.arcpublishing.com/elespectador/AZFUICR3VVGMBJQIHNZAD47ILU.jpg", clientRepository.findById(22L).get()));
        petRepository.save(new Pet("Bear", "Samoyedo", 4, "Laboratorio y diagnóstico por Imágenes", 30.0, "https://www.purina.es/sites/default/files/2021-02/BREED%20Hero_0110_samoyed.jpg", clientRepository.findById(23L).get()));
        ...
        petRepository.save(new Pet("Harley", "Galgo", 4, "Odontología veterinaria", 28.0, "https://elgalgoazul.com/wp-content/uploads/2023/03/curiosidades-sobre-los-galgos-scaled.jpg", clientRepository.findById(26L).get()));
        petRepository.save(new Pet("Bailey", "Rottweiler", 6, "Laboratorio y diagnóstico por Imágenes", 42.0, "https://www.elmueble.com/medio/2023/03/09/perro-de-raza-rottweiler-bebe_4aca739b_230309175845_1000x667.jpg", clientRepository.findById(27L).get()));
        petRepository.save(new Pet("Zoey", "Pastor Belga", 3, "Consultas y chequeos generales", 20.0, "https://nfnatcane.es/blog/wp-content/uploads/2020/07/Pastor-Belga-Groenendael.jpg", clientRepository.findById(28L).get()));
        petRepository.save(new Pet("Benny", "West Highland White Terrier", 5, "Vacunaciones y Desparasitación", 8.0, "https://www.zooplus.es/magazine/wp-content/uploads/2020/01/west-highland-white-terrier.jpg", clientRepository.findById(29L).get()));
