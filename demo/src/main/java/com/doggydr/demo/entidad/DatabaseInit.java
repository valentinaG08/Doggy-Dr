...
public class DatabaseInit implements ApplicationRunner {
    ...
    public void run(ApplicationArguments args) throws Exception {
        ...
        petRepository.save(new Pet("Sadie", "Yorkshire Terrier", 4, "Laboratorio y diagnóstico por Imágenes", 4.0, "", clientRepository.findById(17L).get()));
        petRepository.save(new Pet("Duke", "Pug", 5, "Consultas y chequeos generales", 9.5, "", clientRepository.findById(18L).get()));
        petRepository.save(new Pet("Zoe", "Bichón Frisé", 2, "Vacunaciones y Desparasitación", 5.0, "", clientRepository.findById(19L).get()));
        petRepository.save(new Pet("Jack", "Mastín", 4, "Odontología veterinaria", 40.0, "", clientRepository.findById(20L).get()));
        petRepository.save(new Pet("Maggie", "Maltés", 3, "Laboratorio y diagnóstico por Imágenes", 4.5, "", clientRepository.findById(21L).get()));
        petRepository.save(new Pet("Toby", "Akita", 6, "Consultas y chequeos generales", 32.0, "https://i.imgur.com/RZcMsx9.jpg", clientRepository.findById(22L).get()));
        petRepository.save(new Pet("Stella", "Bóxer", 5, "Vacunaciones y Desparasitación", 26.8, "https://i.imgur.com/JUyH5nX.jpg", clientRepository.findById(23L).get()));
        petRepository.save(new Pet("Bentley", "Schnauzer", 3, "Odontología veterinaria", 8.5, "https://i.imgur.com/aqJbL8D.jpg", clientRepository.findById(24L).get()));
        petRepository.save(new Pet("Chloe", "West Highland White Terrier", 4, "Laboratorio y diagnóstico por Imágenes", 7.5, "https://i.imgur.com/REfyYwz.jpg", clientRepository.findById(25L).get()));
        petRepository.save(new Pet("Zeus", "Dogo Argentino", 5, "Consultas y chequeos generales", 38.0, "https://i.imgur.com/WbMBS2R.jpg", clientRepository.findById(26L).get()));
        petRepository.save(new Pet("Bruno", "Samoyedo", 3, "Vacunaciones y Desparasitación", 25.0, "https://i.imgur.com/mZzqRuF.jpg", clientRepository.findById(27L).get()));
        petRepository.save(new Pet("Nala", "Caniche", 2, "Odontología veterinaria", 4.0, "https://i.imgur.com/D0fUdfr.jpg", clientRepository.findById(28L).get()));
        petRepository.save(new Pet("Thor", "Terranova", 6, "Laboratorio y diagnóstico por Imágenes", 50.0, "https://i.imgur.com/ES1ZRve.jpg", clientRepository.findById(29L).get()));
        petRepository.save(new Pet("Leo", "Weimaraner", 4, "Consultas y chequeos generales", 29.0, "https://i.imgur.com/WaKjW1v.jpg", clientRepository.findById(30L).get()));
        petRepository.save(new Pet("Ellie", "Shetland Sheepdog", 5, "Vacunaciones y Desparasitación", 7.5, "https://i.imgur.com/MLr2VwT.jpg", clientRepository.findById(31L).get()));
        petRepository.save(new Pet("Riley", "Galgo", 3, "Odontología veterinaria", 25.5, "https://i.imgur.com/htyMRsU.jpg", clientRepository.findById(32L).get()));
        petRepository.save(new Pet("Lilly", "Basenji", 2, "Laboratorio y diagnóstico por Imágenes", 10.5, "https://i.imgur.com/dtvSWuZ.jpg", clientRepository.findById(33L).get()));
        ...
        petRepository.save(new Pet("Ginger", "Galgo Italiano", 3, "Vacunaciones y Desparasitación", 6.2, "https://i.imgur.com/1u5FsOg.jpg", clientRepository.findById(35L).get()));
        ...
        petRepository.save(new Pet("Layla", "Husky", 5, "Laboratorioy diagnóstico por Imágenes", 22.0, "https://i.imgur.com/DKFuCeV.jpg", clientRepository.findById(37L).get())); 
        petRepository.save(new Pet("Murphy", "Galgo Afgano", 4, "Consultas y chequeos generales", 26.0, "https://i.imgur.com/NtbHtRh.jpg", clientRepository.findById(38L).get())); 
        petRepository.save(new Pet("Nina", "Pinscher", 2, "Vacunaciones y Desparasitación", 4.5, "https://i.imgur.com/kGhLXy7.jpg", clientRepository.findById(39L).get())); 
        petRepository.save(new Pet("Ollie", "Shar Pei", 3, "Odontología veterinaria", 23.5, "https://i.imgur.com/NoESpYV.jpg", clientRepository.findById(40L).get())); 
        petRepository.save(new Pet("Milo", "Galgo Español", 5, "Laboratorio y diagnóstico por Imágenes", 28.0, "https://i.imgur.com/3UkVZ3j.jpg", clientRepository.findById(41L).get())); 
        petRepository.save(new Pet("Sasha", "Collie", 6, "Consultas y chequeos generales", 22.5, "https://i.imgur.com/s1eOCqk.jpg", clientRepository.findById(42L).get())); 
        petRepository.save(new Pet("Hunter", "Fox Terrier", 4, "Vacunaciones y Desparasitación", 8.0, "https://i.imgur.com/vJAEU0m.jpg", clientRepository.findById(43L).get())); 
        ...
        petRepository.save(new Pet("Simba", "Husky", 3, "Laboratorio y diagnóstico por Imágenes", 22.0, "https://i.imgur.com/Gu2xOxv.jpg", clientRepository.findById(45L).get())); 
        petRepository.save(new Pet("Beau", "Setter Irlandés", 5, "Consultas y chequeos generales", 27.0, "https://i.imgur.com/Q9ByuZ8.jpg", clientRepository.findById(46L).get())); 
        petRepository.save(new Pet("Misty", "Shiba Inu", 3, "Vacunaciones y Desparasitación", 10.0, "https://i.imgur.com/8fTnscR.jpg", clientRepository.findById(47L).get())); 
        petRepository.save(new Pet("Ranger", "Vizsla", 4, "Odontología veterinaria", 24.5, "https://i.imgur.com/zp3vjSx.jpg", clientRepository.findById(48L).get())); 
        petRepository.save(new Pet("Lola", "Golden Retriever", 6, "Laboratorio y diagnóstico por Imágenes", 30.0, "https://i.imgur.com/JODL97f.jpg", clientRepository.findById(49L).get()));
        petRepository.save(new Pet("Finn", "Border Collie", 2, "Vacunaciones y Desparasitación", 15.0, "https://i.imgur.com/Ch3FD3l.jpg", clientRepository.findById(1L).get()));
        petRepository.save(new Pet("Maya", "Jack Russell Terrier", 3, "Odontología veterinaria", 7.5, "https://i.imgur.com/XXfdZly.jpg", clientRepository.findById(2L).get()));
        petRepository.save(new Pet("Riley", "Husky Siberiano", 4, "Laboratorio y diagnóstico por Imágenes", 20.0, "https://i.imgur.com/R4yOfD8.jpg", clientRepository.findById(3L).get()));
        petRepository.save(new Pet("Ziggy", "Bulldog Inglés", 5, "Consultas y chequeos generales", 24.0, "https://i.imgur.com/2sw8Ece.jpg", clientRepository.findById(4L).get()));
        petRepository.save(new Pet("Penny", "Cocker Spaniel", 3, "Vacunaciones y Desparasitación", 12.5, "https://i.imgur.com/UP07wUg.jpg", clientRepository.findById(5L).get()));
        ...
        petRepository.save(new Pet("Millie", "Golden Retriever", 2, "Laboratorio y diagnóstico por Imágenes", 25.0, "https://i.imgur.com/XknTvO7.jpg", clientRepository.findById(7L).get()));
        petRepository.save(new Pet("Otis", "Dachshund", 4, "Consultas y chequeos generales", 9.0, "https://i.imgur.com/YD6dZjQ.jpg", clientRepository.findById(8L).get()));
        petRepository.save(new Pet("Lulu", "Shih Tzu", 5, "Vacunaciones y Desparasitación", 7.0, "https://i.imgur.com/MLckf39.jpg", clientRepository.findById(9L).get()));
        ...
        petRepository.save(new Pet("Gus", "Bulldog Francés", 2, "Laboratorio y diagnóstico por Imágenes", 13.0, "https://i.imgur.com/WmYfjNL.jpg", clientRepository.findById(11L).get()));
        petRepository.save(new Pet("Maggie", "Cavalier King Charles Spaniel", 4, "Consultas y chequeos generales", 8.5, "https://i.imgur.com/n5J3tf8.jpg", clientRepository.findById(12L).get()));
        ...
        petRepository.save(new Pet("Ginger", "Labrador Retriever", 3, "Odontología veterinaria", 22.0, "https://i.imgur.com/nImWDAp.jpg", clientRepository.findById(14L).get()));
        ...
        petRepository.save(new Pet("Chester", "Boston Terrier", 2, "Consultas y chequeos generales", 10.0, "https://i.imgur.com/gj3gRcp.jpg", clientRepository.findById(16L).get()));
        petRepository.save(new Pet("Zara", "Corgi", 4, "Vacunaciones y Desparasitación", 13.5, "https://i.imgur.com/Zu8G5n5.jpg", clientRepository.findById(17L).get()));
        petRepository.save(new Pet("Dexter", "Boxer", 3, "Odontología veterinaria", 24.0, "https://i.imgur.com/utvZpMq.jpg", clientRepository.findById(18L).get()));
        petRepository.save(new Pet("Rex", "Dogo Argentino", 5, "Laboratorio y diagnóstico por Imágenes", 36.0, "https://i.imgur.com/zjvB6jK.jpg", clientRepository.findById(19L).get()));
        petRepository.save(new Pet("Sadie", "Maltés", 2, "Consultas y chequeos generales", 4.0, "https://i.imgur.com/RLh9nUz.jpg", clientRepository.findById(20L).get()));
        petRepository.save(new Pet("Winston", "Doberman", 6, "Vacunaciones y Desparasitación", 38.0, "https://i.imgur.com/lZsP9Og.jpg", clientRepository.findById(21L).get()));
        petRepository.save(new Pet("Sophie", "Pomerania", 3, "Odontología veterinaria", 5.5, "https://i.imgur.com/9zG9dK7.jpg", clientRepository.findById(22L).get()));
        petRepository.save(new Pet("Bear", "Samoyedo", 4, "Laboratorio y diagnóstico por Imágenes", 30.0, "https://i.imgur.com/VOtSzHK.jpg", clientRepository.findById(23L).get()));
        petRepository.save(new Pet("Ruby", "Pastor Australiano", 5, "Consultas y chequeos generales", 25.0, "https://i.imgur.com/mMA19Ek.jpg", clientRepository.findById(24L).get()));
        ...
        petRepository.save(new Pet("Harley", "Galgo", 4, "Odontología veterinaria", 28.0, "https://i.imgur.com/TcAz4X4.jpg", clientRepository.findById(26L).get()));
        petRepository.save(new Pet("Bailey", "Rottweiler", 6, "Laboratorio y diagnóstico por Imágenes", 42.0, "https://i.imgur.com/T7A7Uoy.jpg", clientRepository.findById(27L).get()));
        petRepository.save(new Pet("Zoey", "Pastor Belga", 3, "Consultas y chequeos generales", 20.0, "https://i.imgur.com/OTxvCsN.jpg", clientRepository.findById(28L).get()));
        petRepository.save(new Pet("Benny", "West Highland White Terrier", 5, "Vacunaciones y Desparasitación", 8.0, "https://i.imgur.com/kwh5wYt.jpg", clientRepository.findById(29L).get()));
        petRepository.save(new Pet("Milo", "Cocker Spaniel", 4, "Odontología veterinaria", 13.0, "https://i.imgur.com/Kv2mYYn.jpg", clientRepository.findById(30L).get()));
        petRepository.save(new Pet("Teddy", "Pastor de Anatolia", 3, "Laboratorio y diagnóstico por Imágenes", 28.0, "https://i.imgur.com/KNhV3xi.jpg", clientRepository.findById(31L).get()));
        petRepository.save(new Pet("Coco", "Yorkshire Terrier", 6, "Consultas y chequeos generales", 3.5, "https://i.imgur.com/MwW16L6.jpg", clientRepository.findById(32L).get()));
        petRepository.save(new Pet("Hazel", "Galgo Húngaro", 4, "Vacunaciones y Desparasitación", 18.0, "https://i.imgur.com/zlIbYXA.jpg", clientRepository.findById(33L).get()));
        petRepository.save(new Pet("Blue", "Labrador Retriever", 2, "Odontología veterinaria", 22.5, "https://i.imgur.com/LL8PDEW.jpg", clientRepository.findById(34L).get()));
        ...
        petRepository.save(new Pet("Bentley", "Collie", 3, "Consultas y chequeos generales", 23.0, "https://i.imgur.com/McOotm2.jpg", clientRepository.findById(36L).get()));
        petRepository.save(new Pet("Nala", "Shiba Inu", 4, "Vacunaciones y Desparasitación", 10.5, "https://i.imgur.com/cC0GJk8.jpg", clientRepository.findById(37L).get()));
        petRepository.save(new Pet("Rusty", "Galgo Italiano", 3, "Odontología veterinaria", 19.0, "https://i.imgur.com/xrbxHQ3.jpg", clientRepository.findById(38L).get()));
        petRepository.save(new Pet("Ellie", "Setter Inglés", 5, "Laboratorio y diagnóstico por Imágenes", 25.0, "https://i.imgur.com/nf0mWOD.jpg", clientRepository.findById(39L).get()));
        petRepository.save(new Pet("Maddie", "Border Collie", 2, "Consultas y chequeos generales", 17.0, "https://i.imgur.com/3mLsJym.jpg", clientRepository.findById(40L).get()));
        petRepository.save(new Pet("Moose", "Dálmata", 6, "Vacunaciones y Desparasitación", 24.5, "https://i.imgur.com/kIdTvEI.jpg", clientRepository.findById(41L).get()));
        petRepository.save(new Pet("Lily", "Galgo Español", 3, "Odontología veterinaria", 29.0, "https://i.imgur.com/SmVf5yN.jpg", clientRepository.findById(42L).get()));
        ...
        petRepository.save(new Pet("Chloe", "Galgo Afgano", 5, "Consultas y chequeos generales", 26.0, "https://i.imgur.com/QBl7GmO.jpg", clientRepository.findById(44L).get()));
