...
public class DatabaseInit implements ApplicationRunner {
    ...
    public void run(ApplicationArguments args) throws Exception {
         ...
         * 3. Agregar al objeto del paso 1 el id del 2
         * 4. Guardar el objeto en la tabla del usuario
         */
        ...
        adminSave = new Admin().builder().name("Juan Sebastian").username("juanSe").password("angarita").build();
    ...
    public void createPets() {
        petRepository.save(new Pet("Perry", "French Poodle", 2, "Otitis", 3.4,
                "https://wowmascota.com/wp-content/uploads/2019/05/pets-753464_640.jpg",
                clientRepository.findById(1L).get(), true));
        petRepository.save(new Pet("Lucas", "Labrador", 2, "Gastroenteritis", 6.1,
                "https://es.mypet.com/wp-content/uploads/sites/23/2021/03/ThinkstockPhotos-590080440.jpg?w=1024",
                clientRepository.findById(2L).get(), true));
        petRepository.save(new Pet("Zeus", "Golden Retriever", 2, "Displasia de cadera", 7.4,
                "https://t2.ea.ltmcdn.com/es/posts/1/6/2/10_curiosidades_del_golden_retriever_21261_orig.jpg",
                clientRepository.findById(3L).get(), true));
        petRepository.save(new Pet("Luna", "Siberian Husky", 3, "Sarna", 10.5,
                ...
                clientRepository.findById(2L).get(), true));
        petRepository.save(new Pet("Bella", "Bulldog Francés", 1, "Alergias", 7.0,
                "https://t2.ea.ltmcdn.com/es/posts/4/4/2/cuantos_cachorros_puede_tener_un_bulldog_frances_24244_orig.jpg",
                clientRepository.findById(3L).get(), true));
        petRepository.save(new Pet("Max", "Pastor Alemán", 4, "Dermatitis", 11.0,
                "https://i.blogs.es/a9adf6/kinshuk-bose-pkgzncmkdxo-unsplash/450_1000.jpeg",
                clientRepository.findById(1L).get(), true));
        petRepository.save(new Pet("Charlie", "Bulldog Francés", 2, "Problemas respiratorios", 12.8,
        ...
        petRepository.save(new Pet("Rocky", "Beagle", 4, "Problemas cardíacos", 14.7,
                "https://www.anipedia.net/imagenes/que-comen-los-perros.jpg", clientRepository.findById(5L).get(),
                true));
        petRepository.save(new Pet("Lucy", "Poodle", 6, "Epilepsia", 8.6,
        ...
        petRepository.save(new Pet("Buddy", "Rottweiler", 5, "Osteosarcoma", 35.0,
                ...
                clientRepository.findById(8L).get(), true));
        petRepository.save(new Pet("Daisy", "Chihuahua", 1, "Luxación de rótula", 3.2,
                "https://noticiastu.com/wp-content/uploads/2017/01/99f9ede31328c8484e9e252d08811535.jpg",
                clientRepository.findById(9L).get(), true));
        petRepository.save(new Pet("Bailey", "Cocker Spaniel", 4, "Otitis externa", 13.0,
                "https://png.pngtree.com/png-clipart/20231028/original/pngtree-bailey-dog-transparent-background-png-image_13446258.png",
                clientRepository.findById(10L).get(), true));
        petRepository.save(new Pet("Coco", "Border Collie", 3, "Ceguera progresiva", 17.5,
                "https://3.bp.blogspot.com/-4fZ1pqkpsGc/UUFTVo_SZeI/AAAAAAAAA6w/3vFyEo7Ji30/s1600/5.jpg",
                clientRepository.findById(11L).get(), true));
        petRepository.save(new Pet("Oscar", "Dálmata", 5, "Sordera congénita", 25.3,
                "https://3.bp.blogspot.com/-oKoKqtEKPIo/T1gRb8epcWI/AAAAAAAAV90/zLxHcPblLi8/s1600/Perro-Beagle-en-el-Campo_01.jpg",
                clientRepository.findById(12L).get(), true));
        petRepository.save(new Pet("Ruby", "Husky Siberiano", 4, "Problemas de visión", 22.1,
        ...
        petRepository.save(new Pet("Lola", "Bulldog Inglés", 2, "Problemas respiratorios", 23.7,
                ...
                clientRepository.findById(15L).get(), true));
        petRepository.save(new Pet("Buster", "Shih Tzu", 3, "Problemas oculares", 6.5,
        ...
        petRepository.save(new Pet("Zoe", "Bichón Frisé", 2, "Alergias cutáneas", 5.0,
        ...
        petRepository.save(new Pet("Jack", "Mastín", 4, "Problemas articulares", 40.0,
        ...
        petRepository.save(new Pet("Maggie", "Maltés", 3, "Problemas dentales", 4.5,
                ...
                clientRepository.findById(21L).get(), true));
        petRepository.save(new Pet("Toby", "Akita", 6, "Hipotiroidismo", 32.0,
                ...
                clientRepository.findById(22L).get(), true));
        petRepository.save(new Pet("Stella", "Bóxer", 5, "Cardiomiopatía", 26.8,
                ...
                clientRepository.findById(23L).get(), true));
        petRepository.save(new Pet("Bentley", "Schnauzer", 3, "Problemas oculares", 8.5,
                "https://static.laverdad.es/www/multimedia/202110/14/media/perrete.jpg",
                clientRepository.findById(24L).get(), true));
        petRepository.save(new Pet("Chloe", "West Highland White Terrier", 4, "Problemas de piel", 7.5,
                "https://okdiario.com/img/2021/05/08/mejores-perros-guardianes-655x368.jpg",
                clientRepository.findById(25L).get(), true));
        petRepository.save(new Pet("Zeus", "Dogo Argentino", 5, "Sordera", 38.0,
                "https://es.onlyfresh.com/cdn/shop/articles/dog-g6aa17498a_1920_1024x.jpg?v=1659454762",
                clientRepository.findById(26L).get(), true));
        petRepository.save(new Pet("Bruno", "Samoyedo", 3, "Problemas articulares", 25.0,
                "https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcQZZxhReu_lJXwL3wxhikwSr50UahNvG6sdYw&s",
                clientRepository.findById(27L).get(), true));
        petRepository.save(new Pet("Nala", "Caniche", 2, "Problemas dentales", 4.0,
                "https://okdiario.com/img/2024/08/29/un-estudio-confirma-que-los-perros-cada-vez-son-mas-tontos-y-es-culpa-de-sus-duenos-635x358.jpg",
                clientRepository.findById(28L).get(), true));
        petRepository.save(new Pet("Thor", "Terranova", 6, "Displasia de cadera", 50.0,
                "https://cdn2.dineroenimagen.com/1024x768/filters:format(jpg):quality(75)/media/dinero/images/2022/01/perros-economicos.jpg",
                clientRepository.findById(29L).get(), true));
        petRepository.save(new Pet("Leo", "Weimaraner", 4, "Problemas articulares", 29.0,
                "https://www.hundeo.com/wp-content/uploads/2019/02/Weimaraner-Portra%CC%88t-.jpg",
                clientRepository.findById(30L).get(), true));
        petRepository.save(new Pet("Ellie", "Shetland Sheepdog", 5, "Problemas oculares", 7.5,
                "https://geniusvets.s3.amazonaws.com/gv-dog-breeds/shetland-sheepdog-3.jpg",
                clientRepository.findById(31L).get(), true));
        petRepository.save(new Pet("Riley", "Galgo", 3, "Problemas cardíacos", 25.5,
                "https://cdn.unotv.com/images/2024/01/caracteristicas-del-galgo-jpg-173130.jpg",
                clientRepository.findById(32L).get(), true));
        petRepository.save(new Pet("Lilly", "Basenji", 2, "Problemas de piel", 10.5,
                "https://www.purina.es/sites/default/files/styles/ttt_image_510/public/2024-02/sitesdefaultfilesstylessquare_medium_440x440public2022-08basenji.jpg?itok=0cbpZJgV",
                clientRepository.findById(33L).get(), true));
        petRepository.save(new Pet("Tucker", "Cane Corso", 4, "Displasia de cadera", 42.0,
                "https://www.blogerin.com/wp-content/uploads/2012/10/Fotos-tiernas-de-perritos-wallpapers-2.jpg",
                clientRepository.findById(34L).get(), true));
        petRepository.save(new Pet("Ginger", "Galgo Italiano", 3, "Problemas cardíacos", 6.2,
        ...
        petRepository.save(new Pet("Layla", "Husky", 5, "Problemas oculares", 22.0,
                ...
                clientRepository.findById(37L).get(), true));
        petRepository.save(new Pet("Murphy", "Galgo Afgano", 4, "Problemas cardíacos", 26.0,
        ...
        petRepository.save(new Pet("Milo", "Galgo Español", 5, "Displasia de cadera", 28.0,
                "https://www.kiwoko.com/blogmundoanimal/wp-content/uploads/2024/03/galgo-espanol-raza.jpg",
                clientRepository.findById(41L).get(), true));
        petRepository.save(new Pet("Sasha", "Collie", 6, "Atrofia progresiva de retina", 22.5,
                "https://www.worldlifeexpectancy.com//images/a/d/d/b/collie_rough/collie_rough_1.webp",
                clientRepository.findById(42L).get(), true));
        petRepository.save(new Pet("Hunter", "Fox Terrier", 4, "Luxación de rótula", 8.0,
                "https://www.purina.es/sites/default/files/2021-02/BREED%20Hero_0050_fox_terrier_wire.jpg",
                clientRepository.findById(43L).get(), true));
        petRepository.save(new Pet("Izzy", "Galgo Húngaro", 2, "Enfermedad periodontal", 19.0,
                "https://www.anipedia.net/imagenes/que-comen-los-perros.jpg", clientRepository.findById(44L).get(),
                true));
        petRepository.save(new Pet("Simba", "Husky", 3, "Glaucoma", 22.0,
                "https://static.laverdad.es/www/multimedia/202110/14/media/perrete.jpg",
                clientRepository.findById(45L).get(), true));
        petRepository.save(new Pet("Beau", "Setter Irlandés", 5, "Torsión gástrica", 27.0,
                "https://upload.wikimedia.org/wikipedia/commons/thumb/2/2e/Can_Setter_dog_GFDL.jpg/800px-Can_Setter_dog_GFDL.jpg",
                clientRepository.findById(46L).get(), true));
        petRepository.save(new Pet("Misty", "Shiba Inu", 3, "Alergias cutáneas", 10.0,
                "https://www.lavanguardia.com/files/og_thumbnail/files/fp/uploads/2024/04/08/66141a09dbe9d.r_d.2338-1390-3106.jpeg",
                clientRepository.findById(47L).get(), true));
        petRepository.save(new Pet("Ranger", "Vizsla", 4, "Displasia de codo", 24.5,
                "https://okdiario.com/img/2021/05/08/mejores-perros-guardianes-655x368.jpg",
                clientRepository.findById(48L).get(), true));
        petRepository.save(new Pet("Lola", "Golden Retriever", 6, "Problemas de tiroides", 30.0,
                "https://13630656.rocketcdn.me/wp-content/uploads/2020/01/Golden4.jpg",
                clientRepository.findById(49L).get(), true));
        petRepository.save(new Pet("Finn", "Border Collie", 2, "Epilepsia", 15.0,
                "https://images.ctfassets.net/550nf1gumh01/6dWe4W0fQAJNbTT2GOVoOv/15f5188d1867ea7bdcf5b610d0a699c7/iStock-1420601907.jpg?q=90&w=1240",
                clientRepository.findById(1L).get(), true));
        petRepository.save(new Pet("Maya", "Jack Russell Terrier", 3, "Luxación de rótula", 7.5,
                "https://www.purina.es/sites/default/files/styles/ttt_image_510/public/2024-02/sitesdefaultfilesstylessquare_medium_440x440public2022-09Parson20Russell20Terrier.jpg?itok=8gUiayIr",
                clientRepository.findById(2L).get(), true));
        petRepository.save(new Pet("Riley", "Husky Siberiano", 4, "Problemas renales", 20.0,
                "https://www.purina.es/sites/default/files/styles/ttt_image_510/public/2024-02/sitesdefaultfilesstylessquare_medium_440x440public2022-09Siberian20Husky.jpg?itok=JMtF4wzk",
                clientRepository.findById(3L).get(), true));
        petRepository.save(new Pet("Ziggy", "Bulldog Inglés", 5, "Problemas respiratorios", 24.0,
                "https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcQZZxhReu_lJXwL3wxhikwSr50UahNvG6sdYw&s",
                clientRepository.findById(4L).get(), true));
        ...
        petRepository.save(new Pet("Millie", "Golden Retriever", 2, "Displasia de cadera", 25.0,
                "https://www.aon.es/personales/seguro-perro-gato/wp-content/uploads/sites/2/2021/04/bichon-maltes.jpg",
                clientRepository.findById(7L).get(), true));
        petRepository.save(new Pet("Otis", "Dachshund", 4, "Hernia discal", 9.0,
                "https://media.es.wired.com/photos/65845b5ea4076464da362974/16:9/w_2560%2Cc_limit/Science-Life-Extension-Drug-for-Big-Dogs-Is-Getting-Closer-1330545769.jpg",
                clientRepository.findById(8L).get(), true));
        petRepository.save(new Pet("Lulu", "Shih Tzu", 5, "Infecciones oculares", 7.0,
                "https://content.nationalgeographic.com.es/medio/2023/11/29/golden-retriever-corriendo_7a50f15e_231129131211_800x800.jpg",
                clientRepository.findById(9L).get(), true));
        petRepository.save(new Pet("Shadow", "Pastor Alemán", 3, "Displasia de cadera", 30.0,
                "https://4.bp.blogspot.com/-pesA5apnrsQ/UUMssTjasJI/AAAAAAAABHo/kG_BJ67BW7g/s1600/fotos-imagenes-tiernas%2B(60).jpg",
                clientRepository.findById(10L).get(), true));
        petRepository.save(new Pet("Gus", "Bulldog Francés", 2, "Problemas respiratorios", 13.0,
                "https://cdn2.dineroenimagen.com/1024x768/filters:format(jpg):quality(75)/media/dinero/images/2022/01/perros-economicos.jpg",
                clientRepository.findById(11L).get(), true));
        petRepository.save(new Pet("Maggie", "Cavalier King Charles Spaniel", 4, "Problemas cardíacos", 8.5,
                "https://www.purina.es/sites/default/files/2021-02/BREED%20Hero_0032_king_charles_spaniel.jpg",
                clientRepository.findById(12L).get(), true));
        petRepository.save(new Pet("Louie", "Beagle", 5, "Epilepsia", 14.0,
                "https://3.bp.blogspot.com/-4fZ1pqkpsGc/UUFTVo_SZeI/AAAAAAAAA6w/3vFyEo7Ji30/s1600/5.jpg",
                clientRepository.findById(13L).get(), true));
        petRepository.save(new Pet("Ginger", "Labrador Retriever", 3, "Obesidad", 22.0,
                "https://okdiario.com/img/2024/08/29/un-estudio-confirma-que-los-perros-cada-vez-son-mas-tontos-y-es-culpa-de-sus-duenos-635x358.jpg",
                clientRepository.findById(14L).get(), true));
        petRepository.save(new Pet("Simba", "Akita", 6, "Infección de oído", 35.0,
                "https://i.pinimg.com/originals/5f/35/2c/5f352c6080b6692e617205032083635c.jpg",
                clientRepository.findById(15L).get(), true));
        petRepository.save(new Pet("Chester", "Boston Terrier", 2, "Problemas respiratorios", 10.0,
                "https://es.onlyfresh.com/cdn/shop/articles/dog-g6aa17498a_1920_1024x.jpg?v=1659454762",
                clientRepository.findById(16L).get(), true));
        petRepository.save(new Pet("Zara", "Corgi", 4, "Displasia de cadera", 13.5,
                "https://upload.wikimedia.org/wikipedia/commons/thumb/9/99/Welsh_Pembroke_Corgi.jpg/800px-Welsh_Pembroke_Corgi.jpg",
                clientRepository.findById(17L).get(), true));
        petRepository.save(new Pet("Dexter", "Boxer", 3, "Enfermedad periodontal", 24.0,
        ...
        petRepository.save(new Pet("Winston", "Doberman", 6, "Infección de oído", 38.0,
                "https://www.nutrisslovers.com/Portals/nutrisslovers/Aticulos/Tipos-de-perros-de-terapia/Tipos-de-perros-de-terapia.jpg?ver=2022-09-30-131215-740",
                clientRepository.findById(21L).get(), true));
        petRepository.save(new Pet("Sophie", "Pomerania", 3, "Problemas cardíacos", 5.5,
                "https://cloudfront-us-east-1.images.arcpublishing.com/elespectador/AZFUICR3VVGMBJQIHNZAD47ILU.jpg",
                clientRepository.findById(22L).get(), true));
        petRepository.save(new Pet("Bear", "Samoyedo", 4, "Epilepsia", 30.0,
                "https://www.purina.es/sites/default/files/2021-02/BREED%20Hero_0110_samoyed.jpg",
                clientRepository.findById(23L).get(), true));
        petRepository.save(new Pet("Ruby", "Pastor Australiano", 5, "Obesidad", 25.0,
                "https://shorthand-social.imgix.net/prod/story/ng77nuNXYR/media/6dca4600467911e88355bb16983c6639/original.jpg?w=1100&h=1100&fit=clip&fm=jpg&q=70&auto=format",
                clientRepository.findById(24L).get(), true));
        petRepository.save(new Pet("Murphy", "Bichón Frisé", 3, "Infección de oído", 6.0,
                "https://3.bp.blogspot.com/-oKoKqtEKPIo/T1gRb8epcWI/AAAAAAAAV90/zLxHcPblLi8/s1600/Perro-Beagle-en-el-Campo_01.jpg",
                clientRepository.findById(25L).get(), true));
        petRepository.save(new Pet("Harley", "Galgo", 4, "Displasia de cadera", 28.0,
                "https://elgalgoazul.com/wp-content/uploads/2023/03/curiosidades-sobre-los-galgos-scaled.jpg",
                clientRepository.findById(26L).get(), true));
        petRepository.save(new Pet("Bailey", "Rottweiler", 6, "Problemas respiratorios", 42.0,
                "https://www.elmueble.com/medio/2023/03/09/perro-de-raza-rottweiler-bebe_4aca739b_230309175845_1000x667.jpg",
                clientRepository.findById(27L).get(), true));
        petRepository.save(new Pet("Zoey", "Pastor Belga", 3, "Problemas respiratorios", 20.0,
                "https://nfnatcane.es/blog/wp-content/uploads/2020/07/Pastor-Belga-Groenendael.jpg",
                clientRepository.findById(28L).get(), true));
        petRepository.save(new Pet("Benny", "West Highland White Terrier", 5, "Infección de oído", 8.0,
                "https://www.zooplus.es/magazine/wp-content/uploads/2020/01/west-highland-white-terrier.jpg",
                clientRepository.findById(29L).get(), true));
        petRepository.save(new Pet("Milo", "Cocker Spaniel", 4, "Obesidad", 13.0,
                "https://okdiario.com/img/2024/08/29/un-estudio-confirma-que-los-perros-cada-vez-son-mas-tontos-y-es-culpa-de-sus-duenos-635x358.jpg",
                clientRepository.findById(30L).get(), true));
        petRepository.save(new Pet("Teddy", "Pastor de Anatolia", 3, "Problemas respiratorios", 28.0,
                "https://cdn2.dineroenimagen.com/1024x768/filters:format(jpg):quality(75)/media/dinero/images/2022/01/perros-economicos.jpg",
                clientRepository.findById(31L).get(), true));
        petRepository.save(new Pet("Coco", "Yorkshire Terrier", 6, "Enfermedad periodontal", 3.5,
                "https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcQZZxhReu_lJXwL3wxhikwSr50UahNvG6sdYw&s",
                clientRepository.findById(32L).get(), true));
        petRepository.save(new Pet("Hazel", "Galgo Húngaro", 4, "Problemas de piel", 18.0,
                "https://okdiario.com/img/2021/05/08/mejores-perros-guardianes-655x368.jpg",
                clientRepository.findById(33L).get(), true));
        petRepository.save(new Pet("Blue", "Labrador Retriever", 2, "Displasia de cadera", 22.5,
                "https://as01.epimg.net/diarioas/imagenes/2022/05/29/actualidad/1653826510_995351_1653826595_noticia_normal.jpg",
                clientRepository.findById(34L).get(), true));
        petRepository.save(new Pet("Gracie", "Husky", 5, "Problemas oculares", 27.0,
                "https://www.elmueble.com/medio/2023/03/09/perro-de-raza-rottweiler_9f7a22a7_230309180127_900x900.jpg",
                clientRepository.findById(35L).get(), true));
        petRepository.save(new Pet("Bentley", "Collie", 3, "Hipoalergia", 23.0,
                "https://es.onlyfresh.com/cdn/shop/articles/dog-g6aa17498a_1920_1024x.jpg?v=1659454762",
                clientRepository.findById(36L).get(), true));
        petRepository.save(new Pet("Nala", "Shiba Inu", 4, "Obesidad", 10.5,
                "https://static.laverdad.es/www/multimedia/202110/14/media/perrete.jpg",
                clientRepository.findById(37L).get(), true));
        petRepository.save(new Pet("Rusty", "Galgo Italiano", 3, "Infección de oído", 19.0,
                "https://www.nutrisslovers.com/Portals/nutrisslovers/Aticulos/Tipos-de-perros-de-terapia/Tipos-de-perros-de-terapia.jpg?ver=2022-09-30-131215-740",
                clientRepository.findById(38L).get(), true));
        petRepository.save(new Pet("Ellie", "Setter Inglés", 5, "Problemas respiratorios", 25.0,
                "https://media.es.wired.com/photos/65845b5ea4076464da362974/16:9/w_2560%2Cc_limit/Science-Life-Extension-Drug-for-Big-Dogs-Is-Getting-Closer-1330545769.jpg",
                clientRepository.findById(39L).get(), true));
        petRepository.save(new Pet("Maddie", "Border Collie", 2, "Problemas digestivos", 17.0,
                "https://shorthand-social.imgix.net/prod/story/ng77nuNXYR/media/6dca4600467911e88355bb16983c6639/original.jpg?w=1100&h=1100&fit=clip&fm=jpg&q=70&auto=format",
                clientRepository.findById(40L).get(), true));
        ...
        petRepository.save(new Pet("Chloe", "Galgo Afgano", 5, "Problemas oculares", 26.0,
                "https://content.nationalgeographic.com.es/medio/2023/11/29/golden-retriever-corriendo_7a50f15e_231129131211_800x800.jpg",
                clientRepository.findById(44L).get(), true));
        petRepository.save(new Pet("Scout", "Jack Russell Terrier", 3, "Displasia de cadera", 9.0,
                "https://www.petdarling.com/wp-content/uploads/2020/11/razas-de-perros.jpg",
                clientRepository.findById(45L).get(), true));
        petRepository.save(new Pet("Buddy", "Pastor Belga", 6, "Problemas respiratorios", 34.0,
                "https://i.pinimg.com/originals/5f/35/2c/5f352c6080b6692e617205032083635c.jpg",
                clientRepository.findById(46L).get(), true));
        petRepository.save(new Pet("Lola", "Cocker Spaniel", 4, "Problemas digestivos", 14.0,
                "https://4.bp.blogspot.com/-pesA5apnrsQ/UUMssTjasJI/AAAAAAAABHo/kG_BJ67BW7g/s1600/fotos-imagenes-tiernas%2B(60).jpg",
                clientRepository.findById(47L).get(), true));
        petRepository.save(new Pet("Archie", "Setter Irlandés", 3, "Hipoalergia", 28.0,
                "https://content.elmueble.com/medio/2023/03/30/perro-labrador-retriever_5e8d307f_230330133647_900x900.jpg",
                clientRepository.findById(48L).get(), true));
        petRepository.save(new Pet("Bella", "Galgo Húngaro", 5, "Obesidad", 20.5,
                "https://noticiastu.com/wp-content/uploads/2017/01/99f9ede31328c8484e9e252d08811535.jpg",
                clientRepository.findById(49L).get(), true));
    ...
    public void createVets() {
        ...
        Vet vetSave;
        UserEntity userEntity;
        vetSave = new Vet("Daniel Carvajal", "General",
    ...
    public void createMedicine() {
        ...
        String filePathNico = "C:\\Users\\nikit\\Documents\\UNIVERSIDAD\\Sexto Semestre\\Web Grupo 2\\Back\\Doggy-Dr-nico\\MEDICAMENTOS_VETERINARIA.xlsx";
        String filePathNicoPortatil = "C:\\Users\\Nicolas\\Documents\\UNIVERSIDAD\\SEXTO SEMESTRE\\Desarrollo web grupo 2\\Back\\Doggy-Dr-nico\\Doggy-Dr-nico\\MEDICAMENTOS_VETERINARIA.xlsx";
        ...
        if (file.exists()) {
            ...
            if (file.exists()) {
                ...
                if (file.exists()) {
                    ...
                    System.out.println(
                            "Archivo no encontrado en la ruta de Nico. Intentando con la ruta del portatil...");
                    file = new File(filePathNicoPortatil);
                }
                if (file.exists()) {
                    System.out.println("Archivo encontrado en la ruta de Nico Portatil.");
                } else {
                    System.out.println(
                            "Archivo no encontrado en la ruta de Nico. Intentando con la ruta de Valentina...");
    ...
    public void createTreatment() {
        ...
        treatmentRepository
                .save(new Treatment("Tratamiento de fiebre", medicine1, "Reduce la fiebre en pacientes", vet1, pet1));
        treatmentRepository.save(new Treatment("Tratamiento de infección", medicine2, "Antibiótico para infecciones",
                vet2, petRepository.findById(2L).get()));
        treatmentRepository.save(new Treatment("Tratamiento de alergias", medicine3, "Alivia los síntomas de alergias",
                vet3, petRepository.findById(3L).get()));
        treatmentRepository.save(new Treatment("Tratamiento de diabetes", medicine4, "Control diario para diabetes",
                vet4, petRepository.findById(4L).get()));
        treatmentRepository.save(new Treatment("Tratamiento para resfriado", medicine5,
                "Reduce los síntomas del resfriado", vet5, petRepository.findById(5L).get()));
        treatmentRepository.save(new Treatment("Tratamiento de dolor", medicine6, "Alivio para dolor leve", vet1,
                petRepository.findById(6L).get()));
        treatmentRepository.save(new Treatment("Tratamiento de inflamación", medicine7, "Reduce la inflamación", vet2,
                petRepository.findById(7L).get()));
        treatmentRepository.save(new Treatment("Tratamiento para el control de glucosa", medicine8,
                "Control de glucosa en sangre", vet3, petRepository.findById(8L).get()));
        treatmentRepository.save(new Treatment("Tratamiento combinado", medicine9, "Controla la diabetes y alergias",
                vet4, petRepository.findById(9L).get()));
        treatmentRepository.save(new Treatment("Tratamiento para úlceras", medicine10, "Reduce la acidez estomacal",
                vet5, petRepository.findById(10L).get()));
    }
